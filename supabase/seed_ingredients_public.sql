...
values
  ...
  -- JAJA (EGGS)
  -- ===============================
  ((select id from public.ingredients where name = 'Jajko kurze (całe)'), 'sztuka', 60.00),
  ((select id from public.ingredients where name = 'Jajko kurze (całe)'), 'małe', 50.00),
  ((select id from public.ingredients where name = 'Jajko kurze (całe)'), 'duże', 70.00),
  ((select id from public.ingredients where name = 'Jajko kurze (białko)'), 'sztuka', 33.00),
  ((select id from public.ingredients where name = 'Jajko kurze (żółtko)'), 'sztuka', 17.00),

  -- ===============================
  -- WARZYWA PRZYPRAWOWE
  -- ===============================
  ((select id from public.ingredients where name = 'Czosnek (ząbek)'), 'ząbek', 5.00),
  ((select id from public.ingredients where name = 'Czosnek (ząbek)'), 'główka', 40.00),
  ((select id from public.ingredients where name = 'Cebula biała'), 'mała', 70.00),
  ((select id from public.ingredients where name = 'Cebula biała'), 'średnia', 110.00),
  ((select id from public.ingredients where name = 'Cebula biała'), 'duża', 150.00),
  ((select id from public.ingredients where name = 'Cebula czerwona'), 'mała', 70.00),
  ((select id from public.ingredients where name = 'Cebula czerwona'), 'średnia', 110.00),
  ((select id from public.ingredients where name = 'Szalotka'), 'sztuka', 25.00),
  ((select id from public.ingredients where name = 'Imbir (świeży)'), 'plasterek', 3.00),

  -- ===============================
  -- TŁUSZCZE I OLEJE
  -- ===============================
  -- Oleje (1 łyżka = 15ml, 1 łyżeczka = 5ml)
  ((select id from public.ingredients where name = 'Oliwa z oliwek extra virgin'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Oliwa z oliwek extra virgin'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Olej kokosowy'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Olej kokosowy'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Olej MCT'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Olej avocado'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Olej lniany'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Olej rzepakowy'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Olej sezamowy'), 'łyżeczka', 5.00),

  -- Masło i tłuszcze stałe
  ((select id from public.ingredients where name = 'Masło'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Masło'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Masło'), 'kostka', 200.00),
  ((select id from public.ingredients where name = 'Ghee (masło klarowane)'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Ghee (masło klarowane)'), 'łyżeczka', 5.00),

  -- ===============================
  -- PRODUKTY MLECZNE
  -- ===============================
  ((select id from public.ingredients where name = 'Śmietana 18%'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Śmietana 30%'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Jogurt grecki naturalny (pełnotłusty)'), 'łyżka', 17.00),
  ((select id from public.ingredients where name = 'Jogurt grecki naturalny (pełnotłusty)'), 'opakowanie', 150.00),

  -- ===============================
  -- ORZECHY I NASIONA
  -- ===============================
  -- Orzechy (1 garść = ~30g)
  ((select id from public.ingredients where name = 'Orzechy włoskie'), 'garść', 30.00),
  ((select id from public.ingredients where name = 'Orzechy włoskie'), 'sztuka', 5.00),
  ((select id from public.ingredients where name = 'Migdały'), 'garść', 30.00),
  ((select id from public.ingredients where name = 'Migdały'), 'sztuka', 1.20),
  ((select id from public.ingredients where name = 'Orzechy makadamia'), 'garść', 30.00),
  ((select id from public.ingredients where name = 'Orzechy makadamia'), 'sztuka', 2.00),
  ((select id from public.ingredients where name = 'Orzechy pekan'), 'garść', 30.00),
  ((select id from public.ingredients where name = 'Orzechy brazylijskie'), 'sztuka', 5.00),
  ((select id from public.ingredients where name = 'Orzechy laskowe'), 'garść', 30.00),
  ((select id from public.ingredients where name = 'Orzechy nerkowca'), 'garść', 30.00),

  -- Nasiona (1 łyżka = ~10-15g)
  ((select id from public.ingredients where name = 'Nasiona chia'), 'łyżka', 12.00),
  ((select id from public.ingredients where name = 'Nasiona chia'), 'łyżeczka', 4.00),
  ((select id from public.ingredients where name = 'Nasiona lnu'), 'łyżka', 10.00),
  ((select id from public.ingredients where name = 'Nasiona lnu'), 'łyżeczka', 3.00),
  ((select id from public.ingredients where name = 'Nasiona słonecznika'), 'łyżka', 12.00),
  ((select id from public.ingredients where name = 'Nasiona dyni'), 'łyżka', 12.00),
  ((select id from public.ingredients where name = 'Nasiona sezamu'), 'łyżka', 9.00),
  ((select id from public.ingredients where name = 'Tahini (pasta sezamowa)'), 'łyżka', 16.00),

  -- Masła orzechowe
  ((select id from public.ingredients where name = 'Masło migdałowe (100%)'), 'łyżka', 16.00),
  ((select id from public.ingredients where name = 'Masło migdałowe (100%)'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Masło orzechowe (100% orzeszków ziemnych)'), 'łyżka', 16.00),

  -- ===============================
  -- PRZYPRAWY I ZIOŁA
  -- ===============================
  -- Przyprawy suszone (1 łyżeczka = ~2-5g)
  ((select id from public.ingredients where name = 'Sól'), 'łyżeczka', 6.00),
  ((select id from public.ingredients where name = 'Sól'), 'szczypta', 0.50),
  ((select id from public.ingredients where name = 'Pieprz czarny'), 'łyżeczka', 2.00),
  ((select id from public.ingredients where name = 'Papryka słodka'), 'łyżeczka', 2.30),
  ((select id from public.ingredients where name = 'Papryka ostra'), 'łyżeczka', 2.00),
  ((select id from public.ingredients where name = 'Kurkuma'), 'łyżeczka', 3.00),
  ((select id from public.ingredients where name = 'Oregano (suszone)'), 'łyżeczka', 1.00),
  ((select id from public.ingredients where name = 'Kminek rzymski (kmin)'), 'łyżeczka', 2.10),
  ((select id from public.ingredients where name = 'Cynamon'), 'łyżeczka', 2.60),
  ((select id from public.ingredients where name = 'Gałka muszkatołowa'), 'łyżeczka', 2.20),

  -- Zioła świeże (1 garść = ~10-20g)
  ((select id from public.ingredients where name = 'Bazylia (świeża)'), 'liść', 0.50),
  ((select id from public.ingredients where name = 'Bazylia (świeża)'), 'pęczek', 25.00),
  ((select id from public.ingredients where name = 'Kolendra (świeża)'), 'pęczek', 25.00),
  ((select id from public.ingredients where name = 'Pietruszka (świeża)'), 'pęczek', 30.00),
  ((select id from public.ingredients where name = 'Koper (świeży)'), 'pęczek', 30.00),
  ((select id from public.ingredients where name = 'Szczypiork (świeży)'), 'pęczek', 20.00),

  -- ===============================
  -- DODATKI (CONDIMENTS)
  -- ===============================
  ((select id from public.ingredients where name = 'Musztarda Dijon'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Musztarda Dijon'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Majonez'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Majonez'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Sos sojowy'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Sos sojowy'), 'łyżeczka', 5.00),
  ((select id from public.ingredients where name = 'Ocet winny'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Ocet jabłkowy'), 'łyżka', 15.00),
  ((select id from public.ingredients where name = 'Pasta pomidorowa (koncentrat)'), 'łyżka', 17.00),
  ((select id from public.ingredients where name = 'Pomidory krojone (puszka)'), 'puszka', 400.00),
  ((select id from public.ingredients where name = 'Bulion warzywny (kostka)'), 'kostka', 10.00),
  ((select id from public.ingredients where name = 'Bulion drobiowy (kostka)'), 'kostka', 10.00),

  -- ===============================
  -- MĄKI (FLOURS)
  -- ===============================
  ((select id from public.ingredients where name = 'Mąka migdałowa'), 'szklanka', 112.00),
  ((select id from public.ingredients where name = 'Mąka migdałowa'), 'łyżka', 7.00),
  ((select id from public.ingredients where name = 'Mąka kokosowa'), 'szklanka', 112.00),
  ((select id from public.ingredients where name = 'Mąka kokosowa'), 'łyżka', 7.00),
  ((select id from public.ingredients where name = 'Mąka lniana (len mielony)'), 'łyżka', 7.00),
  ((select id from public.ingredients where name = 'Błonnik witalny (psyllium)'), 'łyżka', 5.00),
  ((select id from public.ingredients where name = 'Błonnik witalny (psyllium)'), 'łyżeczka', 2.00),

  -- ===============================
  -- SŁODZIKI
  -- ===============================
  ((select id from public.ingredients where name = 'Erytrytol'), 'łyżka', 12.00),
  ((select id from public.ingredients where name = 'Erytrytol'), 'łyżeczka', 4.00),
  ((select id from public.ingredients where name = 'Erytrytol'), 'szklanka', 200.00),
  ((select id from public.ingredients where name = 'Ksylitol'), 'łyżka', 12.00),
  ((select id from public.ingredients where name = 'Ksylitol'), 'łyżeczka', 4.00),

  -- ===============================
  -- WARZYWA (przydatne konwersje)
  -- ===============================
  ((select id from public.ingredients where name = 'Awokado'), 'średnie', 200.00),
  ((select id from public.ingredients where name = 'Awokado'), 'duże', 300.00),
  ((select id from public.ingredients where name = 'Pomidor'), 'mały', 80.00),
  ((select id from public.ingredients where name = 'Pomidor'), 'średni', 130.00),
  ((select id from public.ingredients where name = 'Pomidor'), 'duży', 180.00),
  ((select id from public.ingredients where name = 'Pomidory koktajlowe'), 'sztuka', 15.00),
  ((select id from public.ingredients where name = 'Papryka czerwona'), 'średnia', 150.00),
  ((select id from public.ingredients where name = 'Papryka zielona'), 'średnia', 150.00),
  ((select id from public.ingredients where name = 'Papryka żółta'), 'średnia', 150.00),
  ((select id from public.ingredients where name = 'Cukinia'), 'średnia', 250.00),
  ((select id from public.ingredients where name = 'Ogórek'), 'średni', 300.00),
  ((select id from public.ingredients where name = 'Brokuły'), 'główka', 500.00),
  ((select id from public.ingredients where name = 'Kalafior'), 'główka', 600.00),

  -- ===============================
  -- OWOCE
  -- ===============================
  ((select id from public.ingredients where name = 'Truskawki'), 'średnia', 12.00),
  ((select id from public.ingredients where name = 'Truskawki'), 'szklanka', 150.00),
  ((select id from public.ingredients where name = 'Maliny'), 'szklanka', 125.00),
  ((select id from public.ingredients where name = 'Borówki'), 'szklanka', 150.00),
  ((select id from public.ingredients where name = 'Cytryna (sok)'), 'średnia cytryna', 30.00),
  ((select id from public.ingredients where name = 'Limonka (sok)'), 'średnia limonka', 25.00);
...
select 'Total ingredients inserted:' as info, count(*)::text as count from public.ingredients
union all
