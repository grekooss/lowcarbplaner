 ...
 *
 * Button for OAuth authentication (Google)
 * Handles OAuth flow with loading state
 */
...
/**
 * Przycisk logowania/rejestracji przez Google OAuth
 *
 * Wyświetla:
 * - Ikonę Google
 * - Tekst "Kontynuuj z Google"
 * - Loading spinner podczas OAuth flow
 *
 * @example
 * ```tsx
