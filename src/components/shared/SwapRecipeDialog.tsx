...
/**
 * Fallback UI dla błędów w SwapRecipeDialog
 */
function SwapRecipeDialogErrorFallback({ onRetry }: { onRetry: () => void }) {
  return (
    <div className='flex min-h-[200px] flex-col items-center justify-center rounded-lg p-6 text-center'>
      <AlertTriangle className='mb-4 h-10 w-10 text-red-500' />
      <h3 className='mb-2 text-base font-bold text-gray-800'>
        Błąd podczas ładowania zamienników
      </h3>
            ...
            >
              ...
              {error && (
                <div
                  role='alert'
                  aria-live='polite'
                  className='border-error/30 bg-error-bg text-error rounded-lg border p-3 text-xs backdrop-blur-sm sm:rounded-2xl sm:p-4 sm:text-sm'
                >
                  Błąd podczas wczytywania zamienników:{' '}
                    ...
                    <div className='flex flex-1 flex-col justify-center'>
                      ...
                      <div className='flex flex-wrap items-center gap-2.5 text-xs text-black sm:gap-4 sm:text-sm'>
                        ...
                        >
                          ...
                          <span className='text-text-secondary flex items-baseline gap-0.5'>
                            <span className='font-bold'>
                              {Math.round(currentNutrition.net_carbs_g)}
                            </span>
                            <span>g</span>
                          </span>
                        </div>
                          ...
                          <div className='flex flex-wrap items-center gap-2.5 text-xs text-black sm:gap-4 sm:text-sm'>
                            ...
                            >
                              ...
                              <span className='text-text-secondary flex items-baseline gap-0.5'>
                                <span className='font-bold'>
                                  {Math.round(
                                    replacement.total_net_carbs_g ?? 0
                                  )}
                                </span>
                                <span>g</span>
                              </span>
